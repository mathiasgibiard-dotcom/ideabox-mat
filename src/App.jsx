        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px", marginBottom: "8px" }}>
          {["1","2","3","4","5","6","7","8","9"].map(function(n) {
            return (
              ...
              }} style={{ background: "rgba(0,255,136,0.06)", border: "1px solid #00ff8822", borderRadius: "6px", color: "#c8ffd4", fontSize: "18px", fontWeight: "700", padding: "14px", cursor: "pointer", fontFamily: "inherit", transition: "all 0.15s" }}>{n}</button>
            );
          })}
        </div>
